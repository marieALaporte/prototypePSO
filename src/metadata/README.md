 ...
 * [ptpso.yml](ptpso.yml)
     * Determines how your purl.obolibrary.org/obo/ptpso/ redirects will be handled
     ...
     * Paste in the contents of [ptpso.yml](ptpso.yml)
 ...
 * [ptpso.md](ptpso.md)
     ...
     * Paste in the contents of [ptpso.md](ptpso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
